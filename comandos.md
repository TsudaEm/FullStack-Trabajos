...
git push --tags
  Uso: Sube todas las etiquetas locales que no están en el repositorio 
  remoto.

-----------------------------------------------------------------------------

gh auth login
  USO: SE LOGUEA A GITHAB DE FORMA SEMI AUTOMATICA Y AUTENTIFICANDO LA SESION.

gh repo clonec <repositorio>
  USO: CLONA EL REPOSITORIO INDICADO.
